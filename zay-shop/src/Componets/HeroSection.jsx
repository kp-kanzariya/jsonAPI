...
<section className="container py-5">
  ...
  <div className="row">
    <div className="col-12 col-md-4 p-5 mt-3">
      <a href="#"><img src="./assets/img/category_img_01.jpg" className=" img-fluid border" /></a>
      <h5 className="text-center mt-3 mb-3">Watches</h5>
      <p className="text-center"><a className="btn btn-success">Go Shop</a></p>
    </div>
    <div className="col-12 col-md-4 p-5 mt-3">
      <a href="#"><img src="./assets/img/category_img_02.jpg" className=" img-fluid border" /></a>
      <h2 className="h5 text-center mt-3 mb-3">Shoes</h2>
      <p className="text-center"><a className="btn btn-success">Go Shop</a></p>
    </div>
    <div className="col-12 col-md-4 p-5 mt-3">
      <a href="#"><img src="./assets/img/category_img_03.jpg" className=" img-fluid border" /></a>
      ...
      <div className="col-12 col-md-4 mb-4">
        <div className="card h-100">
          ...
          <div className="card-body">
            ...
            <a href="/shop" className="h2 text-decoration-none text-dark">Gym Weight</a>
      ...
      <div className="col-12 col-md-4 mb-4">
        <div className="card h-100">
          ...
          <div className="card-body">
            ...
            <a href="/shop" className="h2 text-decoration-none text-dark">Cloud Nike Shoes</a>
            <p className="card-text">
      ...
      <div className="col-12 col-md-4 mb-4">
        <div className="card h-100">
          ...
          <div className="card-body">
            ...
            <a href="/shop" className="h2 text-decoration-none text-dark">Summer Addides Shoes</a>
            <p className="card-text">
